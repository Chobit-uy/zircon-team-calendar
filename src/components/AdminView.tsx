...
const ALLOWED_COUNTRIES = ['Argentina', 'Uruguay', 'Chile', 'Brasil', 'México', 'Yemen'] as const;
...
const COUNTRY_COLORS: Record<AllowedCountry, string> = {
  ...
  México:    'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300',
