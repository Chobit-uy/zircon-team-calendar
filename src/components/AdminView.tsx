...
const ALLOWED_COUNTRIES = ['Argentina', 'Uruguay', 'Chile', 'Brasil', 'Mexico', 'Yemen'] as const;
...
const COUNTRY_COLORS: Record<AllowedCountry, string> = {
  ...
  Brasil:    'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
  Mexico:    'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300',
  Yemen:     'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
};
